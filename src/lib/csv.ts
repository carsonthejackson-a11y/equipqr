 ...
 * Two optional extras the importer understands but the template leaves out:
 * `service_interval_days` (PM interval; blank = no schedule) and one
 * `cf:<key>` column per custom field defined under Settings → Custom fields.
 */
